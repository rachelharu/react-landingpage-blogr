      ...
      <div
       ...
       mt-10 space-y-0 md:flex-row'>
        ...
        <div className='flex flex-col mb-32 space-y-12 md:w-1/2'>
          <h3 className='mt-10 text-headingColor font-medium text-[24px] md:text-center'>Introducing an extensible editor</h3>
          ...
          <h3 className='mt-10 text-headingColor font-medium text-[24px] md:text-center'>Robust content management</h3>
          <p className='text-bodyColor font-light items-center text-center sm:text-left'>
